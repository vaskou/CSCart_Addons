...
{/if}
<table class="fixed-layout multicolumns-list table-width row-fluid">
{foreach from=$splitted_products item="sproducts" name="sprod"}
<tr{if !$smarty.foreach.sprod.last} class="row-border row-fluid"{/if}>
{foreach from=$sproducts item="product" name="sproducts"}
<!--	<td class="product-spacer">&nbsp;</td>-->
    <td class="product-cell valign-top span{$span_no}">
    {if $product}
