...
{hook name="products:view_main_info"}
    ...
    {include file="common/product_data.tpl" product=$product separate_buttons=$separate_buttons|default:true but_role="big" but_text=__("add_to_cart")}
        ...
        {if !$no_images}
            <div class="image-border center cm-reload-{$product.product_id} csp_span_img_no_border" id="product_images_{$product.product_id}_update">
